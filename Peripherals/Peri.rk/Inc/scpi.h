...
#define CMD_ID(cmd)			(((cmd) >> CMD_ID_SHIFT) & CMD_ID_MASK)
#define CMD_SENDER_ID(cmd)	(((cmd) >> CMD_SENDER_ID_SHIFT) & CMD_SENDER_ID_MASK)
#define A2B_SIZE(cmd)		(((cmd) >> CMD_DATA_SIZE_SHIFT) & CMD_DATA_SIZE_MASK)
